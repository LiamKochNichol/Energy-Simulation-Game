...
slider_tut = pygame.image.load("sprites/slider_tut.png")
slider_tut_tab1 = pygame.image.load("sprites/slider_tut_tab.png")
slider_tut_tab2 = pygame.image.load("sprites/slider_tut_tab.png")
